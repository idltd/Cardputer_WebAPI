...
static const SensorDef SENSORS[] = {
    ...
    },
    {
        ...
        "Use the HC-SR04P (3.3V version) or add a voltage divider (1k + 2k) on the Echo wire. "
    ...
    },
    {
        ...
        "Connect CLK to D, DT to D2. Button pin not used here.",
    ...
    apiServer.http().on("/api/grove/configure", HTTP_POST,
        ...
        [](AsyncWebServerRequest* req, uint8_t* data, size_t len, size_t, size_t) {
            ...
            if (doc.containsKey("stream_interval_ms")) {
                streamIntervalMs = max((unsigned long)100,
                                       (unsigned long)(int)doc["stream_interval_ms"]);
            }
